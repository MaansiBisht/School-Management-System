...
<form method="POST" class="col-12 d-block ajaxForm" action="<?php echo route('student/create_single_student'); ?>" id = "student_admission_form" enctype="multipart/form-data">
    <div class="col-md-12">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
                <select name="class_id" id="class_id" class="form-control select2" data-toggle = "select2"  onchange="classWiseSection(this.value)" >
        ...
        <div class="text-center">
            <button type="submit"  name='submit' class="btn btn-secondary col-md-4 col-sm-12 mb-4"><?php echo get_phrase('add_student'); ?></button>
        </div>
    </div>
</form>
...
function classWiseSection(classId) {
    $.ajax({
        url: "<?php echo route('section/show/'); ?>"+classId,
